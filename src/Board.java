...
public class Board {
	...
	private boolean canMove(Tile tile) {
		...
		switch (tile.getSpecialPosition()) {
			case TOP_LEFT:
				canMove = checkNeighborsFromTopLeft(tile);
				break;
			case TOP_RIGHT:
				canMove = checkNeighborsFromTopRight(tile);
				break;
			case BOTTOM_LEFT:
				canMove = checkNeighborsFromBottomLeft(tile);
				break;
			case BOTTOM_RIGHT:
				canMove = checkNeighborsFromBottomRight(tile);
				break;
			case TOP:
				canMove = checkNeighborsFromTop(tile);
				break;
			case BOTTOM:
				canMove = checkNeighborsFromBottom(tile);
				break;
			case LEFT:
				canMove = checkNeighborsFromLeft(tile);
				break;
			case RIGHT:
				canMove = checkNeighborsFromRight(tile);
				break;
			case NONE:
				canMove = checkNeighborsFromNone(tile);
				break;
		}
	...
	private boolean checkNeighborsFromBottomRight(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean leftNeighborIdentical = (tiles[x][y-1].value == tile.value);
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);

		return leftNeighborIdentical || topNeighborIdentical;
	}

	private boolean checkNeighborsFromTop(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean leftNeighborIdentical = (tiles[x][y-1].value == tile.value);
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
		boolean rightNeighborIdentical = (tiles[x][y+1].value == tile.value);

		return leftNeighborIdentical || bottomNeighborIdentical || rightNeighborIdentical;
	}

	private boolean checkNeighborsFromBottom(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean leftNeighborIdentical = (tiles[x][y-1].value == tile.value);
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);
	...
	private boolean checkNeighborsFromLeft(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
	...
	private boolean checkNeighborsFromRight(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
	...
	private boolean checkNeighborsFromNone(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
	...
	private boolean checkNeighborsFromBottomLeft(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean topNeighborIdentical = (tiles[x-1][y].value == tile.value);
		boolean rightNeighborIdentical = (tiles[x][y+1].value == tile.value);
	...
	private boolean checkNeighborsFromTopRight(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
		boolean leftNeighborIdentical = (tiles[x][y-1].value == tile.value);
	...
	private boolean checkNeighborsFromTopLeft(Tile tile) {
		int x = tile.x;
		int y = tile.y;
		boolean bottomNeighborIdentical = (tiles[x+1][y].value == tile.value);
		boolean rightNeighborIdentical = (tiles[x][y+1].value == tile.value);
